...
#these lines tell python to write some text into a string of "cells" while appennding the utf-8 code.
    writer.writerow(data)
#This line actually write the cell data into the rows, integrating the two.
